                ...
                <div className="bg-zinc-900/50 backdrop-blur-xl border border-zinc-800 rounded-2xl p-8 shadow-2xl">
                    <form className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-3 mt-2">
                            <button
                                formAction={login}
                                className="w-full px-4 py-3 bg-white text-zinc-950 font-semibold rounded-xl hover:bg-zinc-200 transition-colors focus:outline-none focus:ring-2 focus:ring-white/50 shadow-[0_0_20px_rgba(255,255,255,0.1)] hover:shadow-[0_0_25px_rgba(255,255,255,0.2)]"
                            >
                                Entrar
                            </button>
                            <button
                                formAction={signup}
                                className="w-full px-4 py-3 bg-transparent border border-zinc-700 text-white font-semibold rounded-xl hover:bg-zinc-800 transition-colors focus:outline-none focus:ring-2 focus:ring-zinc-500"
                            >
                                Criar Conta
                            </button>
                        </div>
